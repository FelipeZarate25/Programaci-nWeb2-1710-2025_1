...
router.get('/index', (req, res) => {
    res.sendFile(path.join(__dirname, '../public', 'index.html')); // Mandamos el archivo index.html al cliente
});

// Ruta para la página de la calculadora (calculadora.html)
router.get('/calculadora', (req, res) => {
    res.sendFile(path.join(__dirname, '../public', 'calculadora.html')); // Mandamos el archivo calculadora.html
});

// Ruta para la página del generador QR (generadorQR.html)
router.get('/generadorQR', (req, res) => {
    res.sendFile(path.join(__dirname, '../public', 'generadorQR.html')); // Mandamos el archivo generadorQR.html
});
